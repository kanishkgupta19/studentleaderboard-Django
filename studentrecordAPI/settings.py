"""
Django settings for studentrecordAPI project.
...
INSTALLED_APPS = [
    'studentrecord.apps.StudentrecordConfig',
...
ROOT_URLCONF = 'studentrecordAPI.urls'
...
WSGI_APPLICATION = 'studentrecordAPI.wsgi.application'
